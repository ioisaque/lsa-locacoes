...
$mora_data = mora_dt_data();
	...
	if($mora_data['mora_woo_layout'] == 'sidebar-left') {
		$dt_sidebar_class = 'sidebar-left';
		$page_class = 'percent-blog';
	}
	else if($mora_data['mora_woo_layout'] == 'sidebar-right') {
		$dt_sidebar_class = 'sidebar-right';
		$page_class = 'percent-blog';
	}
	
	if($mora_data['mora_woo_layout'] == 'no-sidebar') {
	...
	<?php
		...
		if($mora_data['mora_woo_layout'] != 'no-sidebar') {
			echo '<div class="percent-sidebar widget-area">';
				if(isset($mora_data['mora_woo_sidebar'])) { 
					dynamic_sidebar( $mora_data['mora_woo_sidebar'] ); 
				}
