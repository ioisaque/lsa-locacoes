...
<article id="post-<?php esc_attr(the_ID()); ?>" <?php esc_attr(post_class(array('grid-item', 'wow', 'fadeInUp'))); ?>>
		...
		if ( has_post_thumbnail() ) { ?>
				<div class="post-thumbnail">
					<a href="<?php esc_url(the_permalink()); ?>">
						...
						<?php 
						the_post_thumbnail('mora-blog-grid-thumbnail', array('alt'   => $mora_alt)); 
						?>										
					</a>
				</div><!--end post-thumbnail-->		
			<?php } ?>

		<section class="blog-grid-content-bg">
