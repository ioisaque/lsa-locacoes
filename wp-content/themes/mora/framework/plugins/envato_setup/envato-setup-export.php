...
//			print_r($meta); exit;
		...
		if ( $post_type == 'attachment' ) {
			...
			if ( is_file( $file ) ) {
				...
				if ( is_dir( get_home_path() . '/../dazzle/assets/images/stock/' ) ) {
					copy( $file, get_home_path() . '/../dazzle/assets/images/stock/' . basename( $file ) );
				}
			}
...
$dir = get_home_path() . '/../dazzle/framework/plugins/envato_setup/content/';
...
?>
	<h1>Export Done:</h1>
	<p>Export content has been placed into /dazzle/framework/plugins/envato_setup/content/*.json files</p>
	<p>Stock images have been copied into /dazzle/assets/images/stock/ for faster theme install.</p>
<?php