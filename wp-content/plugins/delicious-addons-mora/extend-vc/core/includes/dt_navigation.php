...
*/ 
function delicious_get_paginated_numbers( $args = null ) {
    ...
    */
    if( false === $args['show_posts_links'] ) {
        ...
        if( 1 === $max_pages ) {
            ...
            */
            $previous_page  = ( $current_page !== 1 )                       ? '<a class="previous" href="' . get_pagenum_link( $current_page - 1 ) . '">' . $args['previous_page_text'] . '</a>' : '';
            $next_page      = ( $current_page !== $max_pages )              ? '<a class="next" href="' . get_pagenum_link( $current_page + 1 ) . '">' . $args['next_page_text'] . '</a>'     : '';
            $first_page     = ( !in_array( 1, $range_numbers ) )            ? '<a class="first" href="' . get_pagenum_link( 1 ) . '">' . $args['first_page_text'] . '</a>'                    : '';
            ...
            */
            ...
            $paginated_text = '<div class="dt_pagination">';
